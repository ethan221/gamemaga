<?php
    $action = $_GET['action'];
    switch($action) { 
            case 'login': function_login(); break;
            case 'adduser': function_adduser(); break;
            case 'deluser': function_deluser(); break;
            case 'edituser': function_edituser(); break;
            case 'addmaga': function_addmaga(); break;
            case 'delmaga': function_delmaga(); break;
            case 'editmaga': function_editmaga();break;
            case 'siteinfo': function_siteinfo(); break;
            case 'delico': function_delico(); break;
            case 'delpage': function_delpage(); break; /* case'addpage': function_addpage(); break; */ 
            case 'addtype': function_addtype(); break;
            case 'deltype': function_deltype(); break;
            case 'edittype': function_edittype(); break;
            case 'logout': function_logout(); break;
            case 'editsystem': function_editsystem(); break;
            case 'delpdf': function_delpdf(); break;
            case 'mphoto': function_mphoto(); break;
            case 'upsort': function_upsort(); break;
            case 'downsort': function_downsort(); break;
            case 'deladphoto': function_delphoto(); break;
            case 'delfolder': function_delfolder(); break;
            case 'delfile': function_delfile(); break;
            case 'delgbook': function_delgbook(); break;
            case 'addbanner': function_addbanner(); break;
            case 'delbanner': function_delbanner();  break;
            case 'upbannersort': function_upbanner(); break;
            case 'downbannersort': function_downbanner();break;
    }
	//下移banner排序
