...
<body style="background:url(/assets/admin/images/bg_login_big.png) 50% 50% ;background-position:center;background-repeat: no-repeat;background-attachment: fixed;}">
<div id="login">
    <div class="login">
