...
<link href="__PUBLIC__/admin/style_upfile.css" rel="stylesheet" type="text/css">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#inputfile").change(function(){
                ...
                data.append('type', '<{$Think.get.type}>');
                $.ajax({
...
<body>
    <div class="file_box">
        <form id='upload-frm' action="" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" id='callback' value="<{$Think.get.callback}>" />
            </form>
    </div>
</body>
</html>