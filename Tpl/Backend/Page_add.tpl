...
<block name="title"><title>新增文章</title></block>
<block name="cssjs_extent">
<link href="__PUBLIC__/admin/artDialog/skins/default.css" rel="stylesheet" type="text/css">
<link href="__PUBLIC__/admin/font-awesome/css/font-awesome.min.css" type="text/css" rel="stylesheet" />
...
<block name="content">
 <div class="rightbox">
        <div class="title">"<{$Think.get.category}>" 新增文章</div>
            ...
            <div class="boxlist">
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr><td colspan="3" class="submit">
                            ...
                            <input type="button" id="return-btn"  value="返回" onclick="exit_info('/backend/page/categoryedit?id=<{$Think.get.categoryid}>&magaid=<{$Think.get.magaid}>');"></td></tr> 
                </table>
                <input type="hidden" name="categoryid" value="<{$Think.get.categoryid}>" />
                <input type="hidden" name="magaid" value="<{$Think.get.magaid}>" />
            </div>
        </form>
    </div>
